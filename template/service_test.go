...
func TestServiceTemplateRendersExtensions(t *testing.T) {
	...
	assertContains(
		"scripts/generate.sh",
		"# Code generated by \"grpc-kit-cli/0.0.1-test\". DO NOT EDIT.",
		"set -e",
		...
		"microservice.gateway.yaml ./public/openapi/",
	)
	assertNotContains(
		"scripts/generate.sh",
		"mv ./api/${PRODUCT_CODE}/${SHORT_NAME}/${API_VERSION}/microservice.swagger.json",
		"protoc-gen-openapiv3",
		"--openapiv3_out",
	)
	assertContains(
		"api/demo/echo/v1/microservice.gateway.yaml",
	...
	assertNotContains("api/demo/echo/v1/microservice.proto", `import "google/api/annotations.proto";`, "option (google.api.http)")
	...
	assertContains("public/embed.go", `// Code generated by "grpc-kit-cli/0.0.1-test". DO NOT EDIT.`, "var Assets embed.FS")
	assertNotContains("public/embed.go", "{{", "}}", ".Global.ReleaseVersion")
	...
	assertContains("go.mod", "go 1.25.13", "github.com/grpc-ecosystem/grpc-gateway/v2 v2.29.0", "github.com/grpc-kit/pkg v0.5.0", "github.com/modelcontextprotocol/go-sdk v1.7.0", "go.opentelemetry.io/otel v1.44.0", "google.golang.org/grpc v1.83.1")
	assertContains("scripts/binaries.sh", `GRPC_GATEWAY_VERSION="v2.30.0"`)
