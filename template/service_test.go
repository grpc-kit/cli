...
func TestServiceTemplateRendersExtensions(t *testing.T) {
	...
	assertContains("go.mod", "go 1.25.13", "github.com/grpc-ecosystem/grpc-gateway/v2 v2.30.0", "github.com/grpc-kit/pkg v0.5.0", "github.com/modelcontextprotocol/go-sdk v1.7.0", "go.opentelemetry.io/otel v1.45.0", "google.golang.org/grpc v1.83.1")
